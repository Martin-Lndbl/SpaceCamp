...
let g:colors_name="spacecamp_transparent"
...
call <sid>hi('Directory', s:spaceBlue, s:none, 'none')
call <sid>hi('FoldColumn', s:none, s:spaceGray1, 'none')
call <sid>hi('Folded', s:spaceGray3, s:none, 'none')
call <sid>hi('IncSearch', s:spaceBlack, s:spaceSteel, 'none')
call <sid>hi('LineNr', s:spaceWhite, s:none, 'none')
call <sid>hi('MatchParen', s:spaceWhite, s:spaceGray3, 'none')
call <sid>hi('Normal', s:spaceWhite, s:none, 'none')
call <sid>hi('Pmenu', s:none, s:spaceBlack2, 'none')
call <sid>hi('PmenuSel', s:none, s:spaceGray2, 'none')
call <sid>hi('Search', s:spaceWhite, s:spaceGray2, 'none')
call <sid>hi('SignColumn', s:none, s:none, 'none')
call <sid>hi('StatusLine', s:spaceWhite, s:none, 'none')
call <sid>hi('StatusLineNC', s:spaceGray3, s:none, 'none')
...
call <sid>hi('NonText', s:spaceGray1, s:none, 'none')
